...
CREATE TABLE IF NOT EXISTS `sgco`.`endereco` (
  ...
  INDEX `cod_cidade_ENUM` (`cod_cidade` ASC),
  PRIMARY KEY (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `sgco`.`permissoes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sgco`.`permissoes` ;

CREATE TABLE IF NOT EXISTS `sgco`.`permissoes` (
  `id_usuario` INT NOT NULL,
  `cod_permissao` INT NOT NULL,
  PRIMARY KEY (`id_usuario`, `cod_permissao`),
  INDEX `fk_permissoes_permissao_idx` (`cod_permissao` ASC),
  ...
  CONSTRAINT `fk_permissoes_usuario`
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_permissoes_permissao`
    FOREIGN KEY (`cod_permissao`)
    REFERENCES `sgco`.`permissao` (`cod`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `sgco`.`procedimentos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sgco`.`procedimentos` ;

CREATE TABLE IF NOT EXISTS `sgco`.`procedimentos` (
  `id_procedimento` INT NOT NULL,
  `id_agendamento` INT NOT NULL,
  PRIMARY KEY (`id_procedimento`, `id_agendamento`),
  INDEX `fk_procedimentos_agendamento_idx` (`id_agendamento` ASC),
  INDEX `fk_procedimentos_procedimento_idx` (`id_procedimento` ASC),
  CONSTRAINT `fk_procedimentos_procedimento`
    FOREIGN KEY (`id_procedimento`)
    REFERENCES `sgco`.`procedimento` (`id`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
  CONSTRAINT `fk_procedimentos_agendamento`
